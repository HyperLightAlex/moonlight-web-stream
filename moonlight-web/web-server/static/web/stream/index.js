    ...
    onMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof message == "string") {
                ...
                if ((_g = window.AndroidBridge) === null || _g === void 0 ? void 0 : _g.onStreamConnected) {
            ...
            // -- WebRTC Config
                ...
                if (sessionToken) {
                    ...
                    if ((_h = window.AndroidBridge) === null || _h === void 0 ? void 0 : _h.onSessionToken) {
            ...
            // -- WebRTC
                ...
                if (this.transport instanceof WebRTCTransport) {
                    ...
                    this.debugLog(`Received WebRTC message but transport is currently ${(_j = this.transport) === null || _j === void 0 ? void 0 : _j.implementationName}`);
                }
            }
        });
    }
