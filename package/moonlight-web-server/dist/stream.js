        ...
        `;
            ...
            keyboardInput.addEventListener("input", (event) => {
                ...
                if (event instanceof InputEvent && event.data) {
                    (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getInput().sendText(event.data);
            ...
            keyboardInput.addEventListener("keydown", (event) => {
                ...
                (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getInput().onKeyDown(event);
            });
            keyboardInput.addEventListener("keyup", (event) => {
                var _a;
                (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getInput().onKeyUp(event);
            });
            ...
            window.MoonlightBridge = {
                ...
                isTouchSupported: () => {
                    ...
                    return (_b = (_a = stream === null || stream === void 0 ? void 0 : stream.getCapabilities()) === null || _a === void 0 ? void 0 : _a.touch) !== null && _b !== void 0 ? _b : false;
                },
                ...
                // Pointer lock
                requestPointerLock: () => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield app.requestPointerLock();
                        return true;
                    }
                    catch (_a) {
                        return false;
                ...
                toggleStats: () => {
                    var _a;
                    const stats = (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getStats();
                    if (stats) {
                        stats.toggle();
                ...
                isStatsVisible: () => {
                    var _a, _b, _c;
                    return (_c = (_b = (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getStats()) === null || _b === void 0 ? void 0 : _b.isEnabled()) !== null && _c !== void 0 ? _c : false;
                },
                // Stream health (for native quality indicator)
                getStreamHealth: () => __awaiter(this, void 0, void 0, function* () {
                    const stream = app.getStream();
                    if (!stream) {
                    ...
                    const health = yield stream.getStreamHealth();
                    return JSON.stringify(health);
                }),
                // Text/Key input (for native soft keyboard)
                sendText: (text) => {
                    var _a;
                    const input = (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getInput();
                    if (input && text) {
                        input.sendText(text);
                        console.info(`[MoonlightBridge] Sent text: "${text}"`);
                    }
                },
                sendKey: (isDown, keyCode, modifiers = 0) => {
                    var _a;
                    const input = (_a = app.getStream()) === null || _a === void 0 ? void 0 : _a.getInput();
                    if (input) {
...
startApp();
class ViewerApp {
    constructor(api, hostId, appId, hybridMode = false) {
        var _a;
    ...
    startStream(hostId, appId, settings, browserSize) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let supportedVideoFormats = yield getSupportedVideoFormats();
