...
export class TrackVideoRenderer extends VideoRenderer {
}
TrackVideoRenderer.type = "videotrack";
export class DataVideoRenderer extends VideoRenderer {
}
DataVideoRenderer.type = "data";
export class FrameVideoRenderer extends VideoRenderer {
}
FrameVideoRenderer.type = "videoframe";
